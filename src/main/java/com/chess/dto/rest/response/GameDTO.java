...
public class GameDTO {
    ...
    public static GameDTO fromGame(com.chess.model.entity.Game game) {
        ...
        String decompressedBoard = CompressionUtil.safeDecompress(game.getBoard()); // Use proper getter method
        // Use Lombok-generated getters for all fields (best practice for encapsulation)
