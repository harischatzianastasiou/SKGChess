...
public class GameHistory {
    ...
    // Keep private constructor for singleton
    private GameHistory() {
        this.boards = new ArrayList<>();
        this.moveHistory = new ArrayList<>();
    }
    
    // Add protected constructor for inheritance/instance creation
    protected GameHistory(boolean createNew) {
        this.boards = new ArrayList<>();
        this.moveHistory = new ArrayList<>();
        this.moveCount = 0;
    }
    ...
    public static GameHistory createNewInstance() {
        return new GameHistory(true);
    }
