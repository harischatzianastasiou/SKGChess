// Login Modal Bouncing Logo Animation Handler
...
function setupBouncingLogo(modalBody) {
    ...
    function animate(currentTime) {
        ...
        // Check boundaries of the modal body - only bounce at edges
        const maxX = modalBody.offsetWidth - logo.offsetWidth;
        const maxY = modalBody.offsetHeight - logo.offsetHeight;
        let collision = false;
    ...
    // Removed the mouseenter/mouseleave event listeners to keep animation running
    // regardless of user interaction with the popup

    // Handle modal body resize
