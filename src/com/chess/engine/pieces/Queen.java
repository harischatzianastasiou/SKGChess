...
public class Queen extends Piece {
	...
	public Collection<Move> calculateMoves(final List<Tile> boardTiles,final MoveResult moveResult, final int oppositeKingCoordinate, final int[] oppositeKingSideCastlePath, final int[] oppositeQueenSideCastlePath){
        final Collection<Move> equivalentRookMoves =  new Rook(this.pieceCoordinate, this.pieceAlliance).calculateMoves(boardTiles,moveResult,oppositeKingCoordinate,oppositeKingSideCastlePath,oppositeQueenSideCastlePath);
        final Collection<Move> equivalentBishopMoves = new Bishop(this.pieceCoordinate, this.pieceAlliance).calculateMoves(boardTiles,moveResult,oppositeKingCoordinate,oppositeKingSideCastlePath,oppositeQueenSideCastlePath);
