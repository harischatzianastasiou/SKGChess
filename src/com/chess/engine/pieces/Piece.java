...
public abstract class Piece {
	...
	public abstract Collection<Move> calculateMoves(final List<Tile> boardTiles, final MoveResult moveResult,final int oppositeKingCoordinate, final int[] oppositeKingSideCastlePath, final int[] oppositeQueenSideCastlePath);
